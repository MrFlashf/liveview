defmodule Pento.FAQTest do
  ...
  describe "questeions" do
    alias Pento.FAQ.Question

    import Pento.FAQFixtures

    @invalid_attrs %{answer: nil, body: nil, vote_count: nil}

    test "list_questeions/0 returns all questeions" do
      question = question_fixture()
      assert FAQ.list_questeions() == [question]
    end
    ...
    test "create_question/1 with valid data creates a question" do
      valid_attrs = %{answer: "some answer", body: "some body", vote_count: 42}
    ...
    test "update_question/2 with valid data updates the question" do
      question = question_fixture()
      update_attrs = %{answer: "some updated answer", body: "some updated body", vote_count: 43}
